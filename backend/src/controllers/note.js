...
const Note = require('../models/note');  // Ensure you have a Note model defined
const { errorHandler } = require('../middleware/error');


const addNote = async (req, res, next) => {
    const { title, content, tags } = req.body;
    const { id } = req.user; // Assuming user information is set via verifyUser middleware
...
module.exports = { addNote, editNote, getAllNotes, deleteNote, updateNotePinned, searchNote };  // Ensure the function is correctly exported
